...
public class AddItemActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        edtSpek = (EditText) findViewById(R.id.edtSpek);
        ...
        btnAddJ = (ImageView) findViewById(R.id.ivAdd);
        ...
        if (extra == null){
            ...
            edtSpek.setText(extra.getString("spek"));
    ...
    public void submit(View view) {
        ...
        String itemSpek = edtSpek.getText().toString();

        if (itemName.equals("") || itemPrice.equals("") || itemValue.equals("0") || itemSpek.equals("")) {
            ...
            if (iditem == null) {
                Call<ModelItem> call = service.insertItem(id, kategori, itemName, itemSpek, itemPrice, Integer.parseInt(itemValue));
                ...
                Call<ModelItem> call = service.updateItem(iditem, id, kategori, itemName, itemSpek, itemPrice, Integer.parseInt(itemValue));
                call.enqueue(new Callback<ModelItem>() {
                    @Override
                    public void onResponse(@NonNull Call<ModelItem> call, @NonNull Response<ModelItem> response) {
