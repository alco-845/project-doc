...
public class ActivityTambahPengeluaran extends AppCompatActivity {
    ...
    public void simpan(View view){
        ...
        String eHKeluar = ActivityCetak.getText(v, R.id.edtHargaKeluar);
        String eKet = ActivityCetak.getText(v, R.id.edtKeteranganTransaksi);

        if (TextUtils.isEmpty(eFaktur) || TextUtils.isEmpty(eHKeluar) || Double.parseDouble(eHKeluar)==0 || TextUtils.isEmpty(eKet) || eFaktur.equals("0")){
            ...
            double saldo = Double.parseDouble(sald) - Double.parseDouble(eHKeluar);
            String idtransaksi = String.valueOf(eFaktur);
            String notransaksi = String.valueOf(eFaktur);
            String stat = "1";
            String qTrans = "";

            qTrans = "INSERT INTO tbltransaksi idtransaksi='"+idtransaksi+"', tgltransaksi='"+convertDate(eTglT)+"', notransaksi='"+notransaksi+"', fakturtransaksi='"+eFaktur+"', keterangantransaksi='"+eKet+"', keluar='"+eHKeluar+"', saldo='"+String.valueOf(saldo)+"', status='"+String.valueOf(stat)+"' ";

            if(Double.parseDouble(ActivityCetak.getText(v, R.id.edtHargaKeluar)) <= Double.parseDouble(sald)){
                if (db.insertTransKeluar(convertDate(eTglT), notransaksi, eFaktur, eKet, eHKeluar, String.valueOf(saldo), stat)){
