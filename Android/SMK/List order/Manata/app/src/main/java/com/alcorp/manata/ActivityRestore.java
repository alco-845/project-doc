...
public class ActivityRestore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dirIn = "/data/data/com.alcorp.manata/databases/";
    ...
    private void askForPermission(String permission, Integer requestCode) {
        if (ContextCompat.checkSelfPermission(ActivityRestore.this, permission) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(ActivityRestore.this, permission)) {
                ActivityCompat.requestPermissions(ActivityRestore.this, new String[]{permission}, requestCode);
            } else {
                ActivityCompat.requestPermissions(ActivityRestore.this, new String[]{permission}, requestCode);
            }
        }
    ...
    protected void onResume() {
        super.onResume();
        ActivityTampil.setText(v,R.id.ePath, "Internal Storage/Download/");
    }

    private void readFile() {
        ArrayList arrayList = new ArrayList() ;
        ArrayAdapter arrayAdapter = new AdapterBackup(this,R.layout.list_item_restore,R.id.wadah,arrayList) ;
        ...
        alertDialogBuilder.setPositiveButton("Restore",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        if(deleteFile(dirIn+config.getDb())){
                            if(ActivityBackup.copyFile(dirOut,dirIn,db)){
