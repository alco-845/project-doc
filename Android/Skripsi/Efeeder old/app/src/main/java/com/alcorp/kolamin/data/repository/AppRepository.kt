package com.alcorp.kolamin.data.repository

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.liveData
import com.alcorp.kolamin.data.network.ApiService
...
class AppRepository(private val apiService: ApiService) {
    ...
    fun getDataBeratTimbangan(): LiveData<String> {
        val data = MutableLiveData<String>()

        apiService.getDataBeratTimbangan().enqueue(object : Callback<String> {
            override fun onResponse(call: Call<String>, response: Response<String>) {
                data.value = response.body()
            }
    ...
    fun getDataBatasSuhu(): LiveData<String> {
        val data = MutableLiveData<String>()

        apiService.getDataBatasSuhu().enqueue(object : Callback<String> {
            override fun onResponse(call: Call<String>, response: Response<String>) {
                data.value = response.body()
            }
    ...
    fun setDataBatasSuhu(nilai: Int): LiveData<String> {
        val data = MutableLiveData<String>()

        apiService.setDataBatasSuhu(nilai).enqueue(object : Callback<String> {
            override fun onResponse(call: Call<String>, response: Response<String>) {
                data.value = response.body()
            }
    ...
    fun getDataBatasKapasitas(): LiveData<String> {
        val data = MutableLiveData<String>()

        apiService.getDataBatasKapasitas().enqueue(object : Callback<String> {
            override fun onResponse(call: Call<String>, response: Response<String>) {
                data.value = response.body()
            }
    ...
    fun setDataBatasKapasitas(nilai: Int): LiveData<String> {
        val data = MutableLiveData<String>()

        apiService.setDataBatasKapasitas(nilai).enqueue(object : Callback<String> {
            override fun onResponse(call: Call<String>, response: Response<String>) {
                data.value = response.body()
            }
