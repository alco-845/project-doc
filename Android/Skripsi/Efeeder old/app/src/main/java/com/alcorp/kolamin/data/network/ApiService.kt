package com.alcorp.kolamin.data.network
...
interface ApiService {
    ...
    //    Start of Batas
    @GET("get?token=$token&v6")
    fun getDataBatasSuhu() : Call<String>

    @GET("update?token=$token")
    fun setDataBatasSuhu(
        @Query("v6") v6: Int
    ) : Call<String>

    @GET("get?token=$token&v7")
    fun getDataBatasKapasitas() : Call<String>

    @GET("update?token=$token")
    fun setDataBatasKapasitas(
        @Query("v7") v7: Int
    ) : Call<String>
    //    End of Batas
